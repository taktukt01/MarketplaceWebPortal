...
-- --------------------------------------------------
-- Date Created: 02/17/2021 14:19:12
...
IF OBJECT_ID(N'[dbo].[FK_dbo_Property_dbo_Application_ApplicationID]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Properties] DROP CONSTRAINT [FK_dbo_Property_dbo_Application_ApplicationID];
GO
IF OBJECT_ID(N'[dbo].[FK_dbo_SubCategory_dbo_Category_CategoryID]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[SubCategories] DROP CONSTRAINT [FK_dbo_SubCategory_dbo_Category_CategoryID];
GO
...
IF OBJECT_ID(N'[dbo].[FK_dbo_TechSpecFilter_dbo_Property_PropertyID]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TechSpecFilters] DROP CONSTRAINT [FK_dbo_TechSpecFilter_dbo_Property_PropertyID];
GO
...
IF OBJECT_ID(N'[dbo].[FK_dbo_TechSpecFilter_dbo_SubCategory_SubCategoryID]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TechSpecFilters] DROP CONSTRAINT [FK_dbo_TechSpecFilter_dbo_SubCategory_SubCategoryID];
GO
IF OBJECT_ID(N'[dbo].[FK_ProductModel]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Models] DROP CONSTRAINT [FK_ProductModel];
GO
IF OBJECT_ID(N'[dbo].[FK_ProductManufacture]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Products] DROP CONSTRAINT [FK_ProductManufacture];
GO
IF OBJECT_ID(N'[dbo].[FK_ID]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Products] DROP CONSTRAINT [FK_ID];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ProductProperties]', 'U') IS NOT NULL
...
GO
IF OBJECT_ID(N'[dbo].[TechSpecFilters]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TechSpecFilters];
GO
...
-- Creating foreign key on [ProductID] in table 'Models'
ALTER TABLE [dbo].[Models]
